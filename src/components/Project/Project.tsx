      ...
      <div className="projects">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Seismic Analysis Of Multi-Storied Institutional Building</h3>
              <p>
                Integrated structural engineering principles to facilitate the understanding and querying of seismic analysis data for multi-storied institutional buildings, based on structural design considerations and aligned with seismic constraints and calculation limitations.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Design Of Earthquake Resistance Commercial Building</h3>
              <p>
                Focused on designing structures resistant to seismic forces using reinforced concrete and steel to enhance stability and durability, ensuring compliance with seismic codes for safe and resilient buildings.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
